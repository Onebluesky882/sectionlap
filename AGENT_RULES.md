...
1. Read tasks/state-[N]-<domain>-gate-out.md from the completed stage
2. Validate all gate criteria (see Gate Validation Rules below)
3. If REJECT: write rejection reason to tasks/state-[N]-<domain>-rejection.md; halt; do not advance
4. If PASS: update PIPELINE.md — set Stage [N] Status = COMPLETE
5. Write tasks/state-[N]-<domain>-merge-approval.md
...
IN PROGRESS → BLOCKED
  ...
  Action:    conductor writes tasks/state-[N]-<domain>-rejection.md; updates PIPELINE.md
...
tasks/state-[N]-<domain>-merge-approval.md
...
Prior Gate-Out: tasks/state-[N]-<domain>-gate-out.md  (N/A if this is Stage 1)
Prior Merge: tasks/state-[N]-<domain>-merge-approval.md  (N/A if this is Stage 1)
...
tasks/state-[N]-<domain>-gate-out.md
