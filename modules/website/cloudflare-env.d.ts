/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 75a15da8fc7f059288b483c4f0573a19)
...
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	VISUAL_PLAN_WORKER_URL: "https://sectionlap-visual-plan.onebluesky882.workers.dev";
	NEXTJS_ENV: string;
	BACKEND_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VISUAL_PLAN_WORKER_URL" | "NEXTJS_ENV" | "BACKEND_URL" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME">> {}
}
